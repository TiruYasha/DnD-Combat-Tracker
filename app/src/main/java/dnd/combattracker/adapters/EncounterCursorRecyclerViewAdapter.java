...
public class EncounterCursorRecyclerViewAdapter extends CursorRecyclerViewAdapter {

    public EncounterCursorRecyclerViewAdapter(Context context, Cursor cursor) {
